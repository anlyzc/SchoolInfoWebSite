<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateUniversity.aspx.cs" Inherits="university_UpdateUniversity" %>
                    ...
                    <div class="col lg-12">
                        <form id="form1" runat="server">
                            ...
                            <div class="form-group">
                                <label for="txtUniversityName">University Name</label>
                                <asp:TextBox runat="server" ID="txtUniversityName" CssClass="form-control"/>
                            </div>
                            <asp:Button Text="Edit" ID="btnSave" runat="server" CssClass="btn btn-success" OnClick="btnSave_Click"/>
                        </form>
                    </div>
                </div>
            </div>
