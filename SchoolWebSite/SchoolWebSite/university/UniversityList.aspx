<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UniversityList.aspx.cs" Inherits="university_UniversityList" %>
                        ...
                        <form id="form2" runat="server">
                            <div class="form-group">
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <asp:Repeater ID="universityList" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    <td><%# Eval("UniID") %></td>
                                                    <td><%# Eval("UniName") %></td>
                                                    <td>
                                                        <asp:HyperLink NavigateUrl='<%# "DeleteUniversity.aspx?id=" + Eval("UniID") %>' runat="server" CssClass="btn btn-danger">Delete</asp:HyperLink>
                                                        <asp:HyperLink NavigateUrl='<%# "UpdateUniversity.aspx?id=" + Eval("UniID") %>' runat="server" CssClass="btn btn-success">Update</asp:HyperLink>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
                                ...
                                <a href="/university/InsertUniversity.aspx" class="btn btn-primary">Add university</a>
                        </form>
                    </div>
                </div>
            </div>
