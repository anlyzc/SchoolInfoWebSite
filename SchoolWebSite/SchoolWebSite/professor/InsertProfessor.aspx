<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InsertProfessor.aspx.cs" Inherits="university_InsertUniversity" %>
                    ...
                    <div class="col lg-12">
                        <form id="form1" runat="server">
                            <div class="form-group">
                                <label for="txtMajorID">Major Name</label>
                                <asp:DropDownList runat="server" CssClass="form-control" ID="majorCombo" AutoPostBack="true">
                                </asp:DropDownList>
                            </div>
                            <div class="form-group">
                                <label for="txtProfessorName">Professor Name</label>
                                <asp:TextBox runat="server" ID="txtProfessorName" CssClass="form-control"/>
                            </div>
