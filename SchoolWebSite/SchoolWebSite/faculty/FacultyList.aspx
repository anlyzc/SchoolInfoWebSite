<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FacultyList.aspx.cs" Inherits="university_UniversityList" %>
                        ...
                        <form id="form2" runat="server">
                            <div class="form-group">
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <asp:Repeater ID="facultyList" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    <td><%# Eval("FacID") %></td>
                                                    <td><%# Eval("FacName") %></td>
                                                    <td><%# GetUniversityName(Convert.ToInt32(Eval("UniID"))) %></td>
                                                    <td>
                                                        <asp:HyperLink NavigateUrl='<%# "DeleteFaculty.aspx?id=" + Eval("FacID") %>' runat="server" CssClass="btn btn-danger">Delete</asp:HyperLink>
                                                        <asp:HyperLink NavigateUrl='<%# "UpdateFaculty.aspx?id=" + Eval("FacID") %>' runat="server" CssClass="btn btn-success">Update</asp:HyperLink>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
                                ...
                                <a href="/faculty/InsertFaculty.aspx" class="btn btn-primary">Add faculty</a>
                        </form>
                    </div>
                </div>
            </div>
