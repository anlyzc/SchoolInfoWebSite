<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MajorList.aspx.cs" Inherits="university_UniversityList" %>
                        ...
                        <form id="form2" runat="server">
                            <div class="form-group">
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <asp:Repeater ID="majorList" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    <td><%# Eval("MajorID") %></td>
                                                    <td><%# Eval("MajorName") %></td>
                                                    <td><%# GetFacultyName(Convert.ToInt32(Eval("FacID"))) %></td>
                                                    <td>
                                                        <asp:HyperLink NavigateUrl='<%# "DeleteMajor.aspx?id=" + Eval("MajorID") %>' runat="server" CssClass="btn btn-danger">Delete</asp:HyperLink>
                                                        <asp:HyperLink NavigateUrl='<%# "UpdateMajor.aspx?id=" + Eval("MajorID") %>' runat="server" CssClass="btn btn-success">Update</asp:HyperLink>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
                                ...
                                <a href="/major/InsertMajor.aspx" class="btn btn-primary">Add major</a>
                        </form>
                    </div>
                </div>
            </div>
