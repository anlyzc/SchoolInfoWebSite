<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InsertMajor.aspx.cs" Inherits="university_InsertUniversity" %>
                    ...
                    <div class="col lg-12">
                        <form id="form1" runat="server">
                            <div class="form-group">
                                <label for="txtFacultyID">Faculty Name</label>
                                <asp:DropDownList runat="server" CssClass="form-control" ID="facultyCombo" AutoPostBack="true">
                                </asp:DropDownList>
                            </div>
                            <div class="form-group">
                                <label for="txtMajorName">Major Name</label>
                                <asp:TextBox runat="server" ID="txtMajorName" CssClass="form-control"/>
                            </div>
