<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentList.aspx.cs" Inherits="university_UniversityList" %>
                    ...
                    <div class="col lg-12">
                        <form id="form2" runat="server">
                            <div class="form-group">
                                        ...
                                        <asp:Repeater ID="studentList" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:HyperLink NavigateUrl='<%# "DeleteStudent.aspx?id=" + Eval("StuID") %>' runat="server" CssClass="btn btn-danger">Delete</asp:HyperLink>
                                                        <asp:HyperLink NavigateUrl='<%# "UpdateStudent.aspx?id=" + Eval("StuID") %>' runat="server" CssClass="btn btn-success">Update</asp:HyperLink>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
                                ...
                                <a href="/student/InsertStudent.aspx" class="btn btn-primary">Add student</a>
                        </form>
                    </div>
                </div>
            </div>
